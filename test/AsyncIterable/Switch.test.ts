...
import * as _ from '../../src/AsyncIterable/Switch'
...
describe('AsyncIterable#Switch', () => {
  ...
  it.concurrent('getSemigroup', async () => {
    ...
    await pipe(S_.concat(AI.fromArray([1, 2]), AI.fromArray([3, 4])), deepStrictEqual([1, 2, 3, 4]))
  })
  ...
  describe('getMonoid', () => {
    ...
    it.concurrent('concat', async () => {
      await pipe(M_.concat(AI.fromArray([1, 2]), AI.fromArray([3, 4])), deepStrictEqual([1, 2, 3, 4]))
    })
  ...
  it.concurrent('flatten', async () => {
    await pipe(AI.fromArray([AI.fromArray([1, 2]), AI.fromArray([3, 4])]), _.flatten, deepStrictEqual([3, 4]))
  })
