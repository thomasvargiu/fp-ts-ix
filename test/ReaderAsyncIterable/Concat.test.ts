...
import * as _ from '../../src/ReaderAsyncIterable/Concat'
...
describe('ReaderAsyncIterable#Concat', () => {
  ...
  it.concurrent('flatten', async () => {
    await pipe(fromArray([fromArray([1, 2]), fromArray([3, 4])]), _.flatten, run({}), deepStrictEqual([1, 2, 3, 4]))
  })
