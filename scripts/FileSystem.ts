...
const readFile = TE.taskify<fs.PathLike | number, BufferEncoding, NodeJS.ErrnoException, string>(fs.readFile)
...
const mkdirTE = TE.taskify<fs.PathLike, { recursive: true }, NodeJS.ErrnoException, string | undefined>(fs.mkdir)
