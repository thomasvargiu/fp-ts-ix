...
import { URI, AsyncIterableEither } from '../AsyncIterableEither'

const AIChain = AIs.ChainWithIndex
const AIMonad = AIs.Monad
 ...
 * @since 2.7.0
 */
export const Alt: Alt2<URI> = AIE.getAlt(AIMonad)
 ...
 * @category instances
 */
export const getSemigroup = <E = never, A = never>(): Semigroup<AsyncIterableEither<E, A>> => AIs.getSemigroup()
...
export const alt = AIE.alt(AIMonad)
 ...
 * @since 2.9.0
 */
export const altW = AIE.altW(AIMonad)
 ...
 * @since 2.12.0
 */
export const chainNullableK = AIE.chainNullableK(AIMonad)
 ...
 * @since 2.10.0
 */
export const matchE = AIE.matchE(AIMonad)
 ...
 * @since 2.0.0
 */
export const fold = AIE.fold(AIMonad)
 ...
 * @since 2.10.0
 */
export const matchEW = AIE.matchEW(AIMonad)
 ...
 * @since 2.10.0
 */
export const foldW = AIE.foldW(AIMonad)

/**
 * @category destructors
 * @since 2.0.0
 */
export const getOrElse = AIE.getOrElse(AIMonad)
 ...
 * @since 2.6.0
 */
export const getOrElseW = AIE.getOrElseW(AIMonad)
 ...
 * @since 2.0.0
 */
export const orElse = AIE.orElse(AIMonad)
 ...
 * @since 2.10.0
 */
export const orElseW = AIE.orElseW(AIMonad)

/**
 * @category combinators
 * @since 2.11.0
 */
export const orElseFirst = AIE.orElseFirst(AIMonad)

/**
 * @category combinators
 * @since 2.11.0
 */
export const orElseFirstW = AIE.orElseFirstW(AIMonad)

/**
 * @category combinators
 * @since 2.12.0
 */
export const orElseFirstIOK = AIE.orElseFirstIOK(AIMonad)

/**
 * @category combinators
 * @since 2.12.0
 */
export const orElseFirstAsyncIterableK = AIE.orElseFirstAsyncIterableK(AIMonad)

/**
 * @category combinators
 * @since 2.11.0
 */
export const orLeft = AIE.orLeft(AIMonad)
 ...
 * @since 2.7.0
 */
export function getAltAsyncIterableValidation<E>(S: Semigroup<E>): Alt2C<URI, E> {
    const aalt = ET.altValidation(AIMonad, S)
    return {
        URI,
        _E: undefined as any,
        map: Monad.map,
 ...
 * @since 2.0.0
 */
export const bracket = AIE.bracket(AIMonad)
 ...
 * @since 2.12.0
 */
export const bracketW = AIE.bracketW(AIMonad)
