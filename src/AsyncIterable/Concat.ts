...
const _map = AI.Functor.map
const _mapWithIndex = AI.FunctorWithIndex.mapWithIndex
const _ap = AI.Apply.ap
...
) => (ma: AsyncIterable<A>) => AsyncIterable<B> = (f) => IXO.concatMap((a, i) => f(i, a))
